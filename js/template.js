...
function addEvents(el, obj) {
  for (var prop in obj) {
    var option = (prop === 'touchstart' || prop === 'touchmove') ? _passiveOption_js__WEBPACK_IMPORTED_MODULE_0__["passiveOption"] : false;
...
/* harmony import */ var _hasAttr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hasAttr.js */ "./node_modules/tiny-slider/src/helpers/hasAttr.js");
/* harmony import */ var _setAttrs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./setAttrs.js */ "./node_modules/tiny-slider/src/helpers/setAttrs.js");



function hideElement(el) {
  if (!Object(_hasAttr_js__WEBPACK_IMPORTED_MODULE_0__["hasAttr"])(el, 'hidden')) {
    Object(_setAttrs_js__WEBPACK_IMPORTED_MODULE_1__["setAttrs"])(el, {'hidden': ''});
  }
}
...
/* harmony import */ var _hasAttr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hasAttr.js */ "./node_modules/tiny-slider/src/helpers/hasAttr.js");
/* harmony import */ var _removeAttrs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./removeAttrs.js */ "./node_modules/tiny-slider/src/helpers/removeAttrs.js");



function showElement(el) {
  if (Object(_hasAttr_js__WEBPACK_IMPORTED_MODULE_0__["hasAttr"])(el, 'hidden')) {
    Object(_removeAttrs_js__WEBPACK_IMPORTED_MODULE_1__["removeAttrs"])(el, 'hidden');
  }
}
...
var tns = function(options) {
  ...
  function initSliderTransform () {
    ...
    if (hasOption('autoHeight') || autoWidth || !horizontal) {
      ...
      Object(_helpers_raf_js__WEBPACK_IMPORTED_MODULE_0__["raf"])(function(){ imageLoaded(Object(_helpers_arrayFromNodeList_js__WEBPACK_IMPORTED_MODULE_23__["arrayFromNodeList"])(imgs), function() {
  ...
  function initTools () {
    ...
    if (hasNav) {
      ...
      Object(_helpers_setAttrs_js__WEBPACK_IMPORTED_MODULE_21__["setAttrs"])(navItems[navCurrentIndex], {'tabindex': '0', 'aria-selected': 'true'});
    ...
    if (hasControls) {
      if (controlsContainer || (prevButton && nextButton)) {
        if (controlsContainer) {
          ...
          Object(_helpers_setAttrs_js__WEBPACK_IMPORTED_MODULE_21__["setAttrs"])(controlsContainer.children, {
...
// === ON RESIZE ===
  ...
  function disableUI () {
    ...
    if (!controls && controlsContainer) { Object(_helpers_hideElement_js__WEBPACK_IMPORTED_MODULE_24__["hideElement"])(controlsContainer); }
  }
  ...
  function enableUI () {
    ...
    if (controls && controlsContainer) { Object(_helpers_showElement_js__WEBPACK_IMPORTED_MODULE_25__["showElement"])(controlsContainer); }
  }
  ...
  function lazyLoad () {
    if (lazyload && !disable) {
      ...
      for(; i < len; i++) {
        Object(_helpers_forEachNodeList_js__WEBPACK_IMPORTED_MODULE_15__["forEachNodeList"])(slideItems[i].querySelectorAll('.tns-lazy-img'), function (img) {
          // stop propagationl transitionend event to container
          var eve = {};
          eve[TRANSITIONEND] = function (e) { e.stopPropagation(); };
          Object(_helpers_addEvents_js__WEBPACK_IMPORTED_MODULE_30__["addEvents"])(img, eve);

          if (!Object(_helpers_hasClass_js__WEBPACK_IMPORTED_MODULE_16__["hasClass"])(img, 'loaded')) {
  ...
  function runAutoHeight () {
    ...
    Object(_helpers_raf_js__WEBPACK_IMPORTED_MODULE_0__["raf"])(function(){ imageLoaded(imgs, updateInnerWrapperHeight); });
  }
  ...
  function imageLoaded (imgs, cb) {
    ...
    Object(_helpers_raf_js__WEBPACK_IMPORTED_MODULE_0__["raf"])(function(){ imageLoaded(imgs, cb); });
  } 
  ...
  function onPanMove (e) {
    if (panStart) {
      ...
      if (carousel && !rafIndex) { rafIndex = Object(_helpers_raf_js__WEBPACK_IMPORTED_MODULE_0__["raf"])(function(){ panUpdate(e); }); }
    }
  }
  ...
  function updateMoveDirectionExpected () {
    if (
      ...
      moveDirectionExpected = Object(_helpers_getTouchDirection_js__WEBPACK_IMPORTED_MODULE_14__["getTouchDirection"])(Object(_helpers_toDegree_js__WEBPACK_IMPORTED_MODULE_13__["toDegree"])(lastPosition.y - initPosition.y, lastPosition.x - initPosition.x), swipeAngle) === options.axis;
    }
  }
    ...
    if (visibleNavIndexes !== visibleNavIndexesCached) {
      Object(_helpers_forEachNodeList_js__WEBPACK_IMPORTED_MODULE_15__["forEachNodeList"])(navItems, function(el, i) {
        if (visibleNavIndexes.indexOf(i) < 0) {
          Object(_helpers_hideElement_js__WEBPACK_IMPORTED_MODULE_24__["hideElement"])(el);
        } else {
          Object(_helpers_showElement_js__WEBPACK_IMPORTED_MODULE_25__["showElement"])(el);
        }
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return carouselsSetup; });
...
function carouselsSetup() {
  ...
  var options_1 = _objectSpread({}, opinions, {
    slideBy: 'page',
    autoplayTimeout: 2000,
    controls: false
  });

  var options_2 = _objectSpread({}, opinions, {
  ...
  var options_3 = _objectSpread({}, opinions, {
    slideBy: 'page',
    autoplayTimeout: 3000
  });

  if (document.querySelector('.carousel .nav-tools')) {
    var carouselSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_1, {
  ...
  if (document.querySelector('.rooms')) {
    var cardSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_1, {
      autoWidth: true,
  ...
  if (document.querySelector('.special-offers')) {
    var offerSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_1, {
      autoWidth: true,
  ...
  if (document.querySelector('.posts')) {
    var opinionSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_2, {
      container: '.posts .post-list',
      controlsContainer: ".posts .carousel-pagination",
      navContainer: '.posts .nav-tools'
    }));
    var paginationPages = Array.from(document.querySelector('.posts .carousel-pagination .pages').children);
    var imagesList = Array.from(document.querySelector('.expert-opinion .image-list').children);
    paginationPages[0].classList.add('active');
    imagesList[0].classList.add('active');

    var moveNavSlider = function moveNavSlider(info) {
      paginationPages.forEach(function (paginationPage) {
        return paginationPage.classList.remove('active');
      });
  ...
  if (document.querySelector('.reviews')) {
    var reviewSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_2, {
  ...
  if (document.querySelector('.carousel-with-arrows')) {
    var _reviewSlider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_0__["tns"])(_objectSpread({}, options_3, {
...
function () {
  function Contacts() {
    ...
    this.toggles.forEach(function (toggle) {
      return toggle.addEventListener('click', _this.onClick);
    });
  }
  ...
  _createClass(Contacts, [{
    ...
    value: function onClick(event) {
      this.contacts.forEach(function (body) {
        return body.classList.toggle('show');
      });
    }
  }]);
...
function () {
  function DatePickers() {
    ...
    if (this.isMobile) {
      this.datePickerLabels.forEach(function (label) {
        return label.classList.add('isMobile');
      });
    }
    ...
    this.datePickers.forEach(function (datePicker) {
      datePicker.addEventListener('change', function (event) {
        var intutId = event.target.id;

        if (intutId) {
          var label = document.querySelector("[for=\"".concat(intutId, "\"]"));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ExtraMenu; });
/* harmony import */ var _dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dropdown */ "./src/scripts/dropdown.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(ExtraMenu, [{
    ...
    key: "checkNeedUseExtraMenu",
    value: function checkNeedUseExtraMenu() {
      return this.navbar.offsetWidth - (this.menu.offsetWidth + this.logo.offsetWidth) < 100;
    }
  }, {
    key: "changeExtraMenuChildren",
    value: function changeExtraMenuChildren() {
      if (this.checkNeedUseExtraMenu()) {
        var itemToMove = this.getLastNavbarMenuChild();
    ...
    key: "getLastNavbarMenuChild",
    value: function getLastNavbarMenuChild() {
      var navbarMenuItems = document.querySelectorAll('.navbar-menu > .navbar-item');
      return navbarMenuItems ? Array.prototype.slice.call(navbarMenuItems, -1)[0] : nill;
    }
  }, {
    key: "letGoExtraMenuItems",
    value: function letGoExtraMenuItems() {
    ...
    value: function initExtraMenu() {
      ...
      new _dropdown__WEBPACK_IMPORTED_MODULE_0__["default"](this.extraMenu);
      this.extraMenuBody = document.querySelector('#more-navbar-menu .dropdown-menu');
      this.changeExtraMenuChildren();
    }
  }, {
    key: "resizeExtraMenu",
    value: function resizeExtraMenu() {
      var _this = this;
      ...
      if (!this.resizeTimeout) {
        ...
        this.resizeTimeout = setTimeout(function () {
          ...
          _this.resizeExtraMenuHandler();
        }, 100);
      }
    }
  }, {
    key: "resizeExtraMenuHandler",
    value: function resizeExtraMenuHandler() {
      if (this.checkNeedUseExtraMenu() && !this.checkIsMobile()) {
...
/* harmony import */ var _navbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navbar */ "./src/scripts/navbar.js");
/* harmony import */ var _contacts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contacts */ "./src/scripts/contacts.js");
/* harmony import */ var _dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dropdown */ "./src/scripts/dropdown.js");
/* harmony import */ var _extra_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./extra-menu */ "./src/scripts/extra-menu.js");
/* harmony import */ var _carousels__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./carousels */ "./src/scripts/carousels.js");
/* harmony import */ var _datepickers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./datepickers */ "./src/scripts/datepickers.js");
/* harmony import */ var _textfieldsetup__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./textfieldsetup */ "./src/scripts/textfieldsetup.js");
...
function main() {
  new _navbar__WEBPACK_IMPORTED_MODULE_2__["default"]();
  new _contacts__WEBPACK_IMPORTED_MODULE_3__["default"]();
  new _extra_menu__WEBPACK_IMPORTED_MODULE_5__["default"]();
  new _datepickers__WEBPACK_IMPORTED_MODULE_7__["default"]();
  new _textfieldsetup__WEBPACK_IMPORTED_MODULE_8__["default"](document.querySelectorAll('textarea'));
  new _textfieldsetup__WEBPACK_IMPORTED_MODULE_8__["default"](document.querySelectorAll('input[type="text"]'));
  new _textfieldsetup__WEBPACK_IMPORTED_MODULE_8__["default"](document.querySelectorAll('input[type="email"]'));
  Array.from(document.querySelectorAll('.dropdown')).forEach(function (dropdown) {
    new _dropdown__WEBPACK_IMPORTED_MODULE_4__["default"](dropdown);
  });
  Object(_carousels__WEBPACK_IMPORTED_MODULE_6__["default"])();
  flatpickr__WEBPACK_IMPORTED_MODULE_1___default()("#checkIn", {});
  flatpickr__WEBPACK_IMPORTED_MODULE_1___default()("#checkOut", {});
  flatpickr__WEBPACK_IMPORTED_MODULE_1___default()("#from", {});
  flatpickr__WEBPACK_IMPORTED_MODULE_1___default()("#to", {});
  autosize__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll('textarea'));
}
...
function () {
  function NavBar() {
    ...
    this.links.forEach(function (link) {
      return link.addEventListener('click', _this.onClick);
    });
  ...
  _createClass(NavBar, [{
    ...
    value: function onToggleClick() {
      var toggleIcon = document.querySelector('.navbar-toggler i');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TextFielsdSetup; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function TextFielsdSetup(textFileds) {
    var _this = this;

    _classCallCheck(this, TextFielsdSetup);

    this.textFileds = Array.from(textFileds);
    this.onKeyUp = this.onKeyUp.bind(this);
    this.textFileds.forEach(function (textFiled) {
      return textFiled.addEventListener('keyup', _this.onKeyUp);
    });
  }

  _createClass(TextFielsdSetup, [{
    key: "onKeyUp",
